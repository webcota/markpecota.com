	...
	if ( '' != $search_form_template ) {
		...
		if ( 'html5' == $format ) {
			$form = '<form role="search" method="get" class="search-form" action="' . esc_url( home_url( '/' ) ) . '">
				<label>
					<span class="screen-reader-text fa fa-search">fa-search</span>
			...
			$form = '<form role="search" method="get" id="searchform" class="searchform" action="' . esc_url( home_url( '/' ) ) . '">
				<div>
					<label class="screen-reader-text fa fa-search fa-lg" for="s"></label>
					<input type="text" class="no-show inputs" value="' . get_search_query() . '" name="s" id="s" />
					<input type="submit" class="no-show inputs" id="searchsubmit" value="'. esc_attr_x( 'Search', 'submit button' ) .'" />
				</div>
			</form>';
		}
	}
